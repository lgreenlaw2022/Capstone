                ...
                <div className={styles.textBlock}>
                    <ol>
                        ...
                        <ul>
                            ...
                            <li>
                                Install the necessary language extensions
                                (install Python{" "}
                                <a
                            ...
                            <li>
                                Set up a dedicated folder for coding practice
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                Include the problem description as comments at
                                the top
                            </li>
                        ...
                        <ul>
                            <li>
                                Implement a solution class/function as specified
                            ...
                            <li>
                                Use print statements or the debugger to verify
                                your solution
                            </li>
                            <li>
